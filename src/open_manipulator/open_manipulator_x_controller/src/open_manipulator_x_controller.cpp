...
{
// The "sim" parameter is a boolean (true/false). Let's give it a default value of false.
  this->declare_parameter("sim", false);

// The "control_period" is a time in seconds (a double). Let's give it a reasonable default.
