...
class InverseKinematicsNode(Node):
    ...
    def __init__(self):
        ...
        # Joint 1 (Base)
        self.joint1_min = np.deg2rad(-90)
        self.joint1_max = np.deg2rad(90)
        
        # Joint 2 (Shoulder)
        self.joint2_min = np.deg2rad(-150)
        self.joint2_max = np.deg2rad(150)
        
        # Joint 3 (Elbow)
        self.joint3_min = np.deg2rad(-100)
        self.joint3_max = np.deg2rad(100)

        # Joint 4 (Wrist)
        self.joint4_min = np.deg2rad(-90)
        self.joint4_max = np.deg2rad(90)
